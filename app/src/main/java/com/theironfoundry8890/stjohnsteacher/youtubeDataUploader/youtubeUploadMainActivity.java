...
import com.theironfoundry8890.stjohnsteacher.youtubeDataUploader_util.NetworkSingleton;
import com.theironfoundry8890.stjohnsteacher.youtubeDataUploader_util.Upload;
import com.theironfoundry8890.stjohnsteacher.youtubeDataUploader_util.Utils;
 ...
 */
public class youtubeUploadMainActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isCorrectlyConfigured()) {
            setContentView(R.layout.youtube_uploader_developer_setup_required);
            showMissingConfigurations();
        } else {
            setContentView(R.layout.youtube_uploader_activity_main);
        ...
        new AsyncTask<Void, Void, List<VideoData>>() {
            ...
            protected List<VideoData> doInBackground(Void... voids) {
                ...
                try {
                    ...
                    Utils.logAndShow(youtubeUploadMainActivity.this, Constants.APP_NAME, e);
                }
                return null;
            }
    ...
    public void onVideoSelected(VideoData video) {
        ...
        Log.v("youtube",video.getYouTubeId());
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                Dialog dialog = GooglePlayServicesUtil.getErrorDialog(
                        connectionStatusCode, youtubeUploadMainActivity.this,
