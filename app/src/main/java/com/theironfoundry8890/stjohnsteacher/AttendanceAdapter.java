...
public class AttendanceAdapter extends ArrayAdapter<Word> {

    private int mColorResourceId;

    public AttendanceAdapter(Activity context, ArrayList<Word> words ) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // defaultTextView.setText(currentword.getEventDate());
