...
public class t_class_add extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t_class_adder);
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            int a = 2;
            idAvailcheck = true;
            String range = "Class Name!".concat("A"+ a++ + ":S");
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                ...
                Log.v("t_class_add" , "damn");
            } else {
                output.add(0, " ");
                mOutputText.setText(TextUtils.join("\n", output));
                Log.v("t_class_add" , String.valueOf(idAvailcheck));
                displayAvailability();
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            t_class_add.REQUEST_AUTHORIZATION);
                } else {
                    mOutputText.setText("The following error occurred:\n"
                            + mLastError.getMessage());
                    Log.v("t_class_add" , "Worked2");
                    Log.v("t_class_add" , String.valueOf(idAvailcheck));
                    displayAvailability();
                }
            } else {
