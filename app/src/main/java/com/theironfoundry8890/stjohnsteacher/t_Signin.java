...
public class t_Signin extends Activity
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            idCheck = false;
            passCheck = false;
            String range = "Teacher Data!".concat("A"+ a++ + ":I");
                ...
                for (List row : values) {
                    ...
                    if (dId.contains(sId))
                    {
                        ...
                        if(dPassword.equals(sPassword)) {
                            ...
                            dEmail = String.valueOf(dRow.get(4));
                            dPhone = String.valueOf(dRow.get(5));
                            dTable = String.valueOf(dRow.get(6));


                            Log.v("info" , dLName.concat(dFName + dEmail + dPhone));
                            break;
                        }
                        break;
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            t_Signin.REQUEST_AUTHORIZATION);
                } else {
                    mOutputText.setText("The following error occurred:\n"
                            + mLastError.getMessage());
                    Log.v("t_Signin" , "Worked2");
                    checkAuthencity();
                }
            } else {
    ...
    public void onClickSignup (View v) {
        ...
        Intent selectIntent = new Intent(t_Signin.this,t_SignUp.class);
        startActivity(selectIntent);
