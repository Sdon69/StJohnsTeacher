...
public class t_section_add extends Activity
    ...
    private String mode = "sectionfeed";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t_section_adder);
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            String spreadsheetId = "1nzKRlq7cQrI_XiJGxJdNax5oB91bR_SypiazWO2JTuU";
            int a = 1;
            idAvailcheck = true;
            String range = "Sections!".concat("A"+ a++ + ":S");
            ...
            if (values != null) {
                ...
                for (List row : values) {
                    ...
                    if(mode=="sectionfeed")
                    {
                            ...
                            Log.v("Ss", String.valueOf(className));
                    ...
                    if(mode=="Submit") {
                        ...
                        if (Str1.equals(subjectAbb)) {
                            String sClass = String.valueOf(row.get(1));
                            if(sClass.equals(dept_filter)) {
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                ...
                Log.v("t_section_add" , "damn");
            } else {
                output.add(0, " ");
                mOutputText.setText(TextUtils.join("\n", output));
                Log.v("t_section_add" , String.valueOf(idAvailcheck));
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            t_section_add.REQUEST_AUTHORIZATION);
                } else {
                    mOutputText.setText("The following error occurred:\n"
                            + mLastError.getMessage());
                    Log.v("t_section_add" , "Worked2");
                    Log.v("t_section_add" , String.valueOf(idAvailcheck));
    ...
    public void submitInfo(View view) {
        ...
        if (subjectAbb.length() >= 1) {
            if (!dept_filter.equals("Class")) {
                ...
                Toast.makeText(getApplicationContext(), "Please Choose a Class",
                        Toast.LENGTH_SHORT).show();
            }

        } else {
            Toast.makeText(getApplicationContext(), "Enter Subject Abbreviation",
                    Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void displayAvailability() {
        ...
        if (!idAvailcheck)
        {
            Toast.makeText(getApplicationContext(), " Section Already Exists ",
                    Toast.LENGTH_SHORT).show();
        }
                                      }
    ...
    public void classList()
    {
        ...
        Spinner sItems = (Spinner) findViewById(R.id.spinner_dept);
