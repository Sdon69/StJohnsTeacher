...
public class EventWriter extends Activity
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            List<List<Object>> arrData = getData(eventTitle , eventDescription ,
                    publishDate,eventDate,lastDateOfRegistration,entryfees, savedId , subCataegories );
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                ...
                Log.v("EventWriter" , "damn");
            } else {
                output.add(0, " ");
                mOutputText.setText(TextUtils.join("\n", output));
                Log.v("EventWriter" , "Wofdad21");
                displayAvailability();
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            EventWriter.REQUEST_AUTHORIZATION);
                } else {
                    mOutputText.setText("The following error occurred:\n"
                            + mLastError.getMessage());
                    Log.v("EventWriter" , "Worked2");
                }
            } else {
    ...
    public static List<List<Object>> getData (String pTitle , String pDesc, String pPublishDate , String pEventDate ,
                                              String pEndDateReg ,String pFees , String pId ,String cataegories )  {
                ...
                if (entryfees.length() >= 1) {
                    if (confirmPass.length() >= 8) {
                        if (confirmPass.equals(savedPass)) {
                            if(technology || socialGathering || debate ||  convention || socialAwareness || other ) {
